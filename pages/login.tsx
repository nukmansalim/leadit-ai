...
export default function Login() {
    ...
    return (
        <>
            <Head>
                <title>Leadit Intelligence - Masuk</title>
            </Head>
                        ...
                        <div className="w-full bg-white border border-[#e2e8f0] rounded-2xl p-8 shadow-[0_1px_3px_rgba(0,0,0,0.04),0_6px_24px_rgba(0,0,0,0.04)] flex flex-col gap-6">
                            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                                ...
                                <div className="relative flex items-center justify-center py-2">
                                    ...
                                    <span className="relative px-4 bg-white text-[10px] text-[#64748B] uppercase font-bold tracking-widest">Atau</span>
                                </div>

                                <button
                                    type="button"
                                    className="w-full border border-[#e2e8f0] text-[#0F172A] font-medium py-3.5 rounded-xl flex items-center justify-center gap-3 hover:bg-[#F8FAFC] hover:border-[#cbd5e1] transition-all duration-200"
                                >
